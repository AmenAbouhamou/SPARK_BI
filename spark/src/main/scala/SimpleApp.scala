...
//    var path_init: String = "/Virtuel/aa224325/BI/";
    ...
    var urlOracle: String = "jdbc:oracle:thin:@stendhal:1521:ENSS2024";
    var cnxOracle: Properties = new Properties();
...
//    integrate_time_tip(spark, shoptip, urlPostgres_kafka, cnxPostgres_kafka)
//
...
//    integrate_time(spark, shopcheckin)
//
//    // Call the integrate method from time_review_EL
//    integrate_time_review(spark)
//
